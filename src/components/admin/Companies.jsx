        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 mt-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 items-center w-full sm:w-auto">
            <Input
              ...
              className="rounded-xl shadow-sm w-full sm:w-64 border border-gray-300 focus:ring-2 focus:ring-[#4B2996]/30 bg-[#f6f4fd] text-[#2d1a4d] placeholder:text-[#b3a6d9]"
            />
            <Button
              className="bg-gradient-to-r from-[#6A38C2] to-[#F83002] text-white rounded-xl shadow-md hover:from-[#4B2996] hover:to-[#c72a00] w-full sm:w-auto font-semibold px-6 py-2 border-0"
